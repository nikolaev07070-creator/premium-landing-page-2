...
// Hero image path
const HERO_IMAGE = "/lab/hero-teeth.png";
...
export function DentalHero() {
  return (
    ...
    >
      ...
      {/* Background Elements with Grain */}
      <div className="absolute inset-0 bg-background" style={{ zIndex: -1 }}>
        ...
        <div className="absolute top-1/2 right-1/3 w-[600px] h-[600px] border border-border/10 rounded-full" />
        <div className="absolute top-1/2 right-1/3 w-[400px] h-[400px] border border-border/5 rounded-full" />
      </div>
      
      {/* Left Vertical Brand Text */}
      <div className="absolute left-8 top-1/2 -translate-y-1/2 hidden xl:block" style={{ zIndex: 1 }}>
        <div className="vertical-text text-2xl font-normal text-muted-foreground/20 uppercase tracking-[0.3em]">
          ESTHETIC DENTAL
        </div>
      </div>

      {/* Vertical Label - ESTHETIC DENTAL LAB */}
      ...
      <div className="relative z-10">
        ...
        <div className="grid lg:grid-cols-[1fr_1.3fr] gap-16 lg:gap-24 items-center max-w-7xl mx-auto">
          ...
          <div className="relative flex items-center justify-center lg:justify-end lg:ml-12 xl:ml-16">
            <div className="relative w-[280px] md:w-[360px] lg:w-[500px] xl:w-[600px] h-auto lg:transform lg:-translate-x-20 lg:-translate-y-10">
              <Image
                src={HERO_IMAGE}
